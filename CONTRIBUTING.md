...
posted to the project's [Discord](https://discord.gg/4UrbVzV) server.
...
Copyright (c) 2017-2018 The WolfCoin Project.
...
The "WolfCoin Maintainer Team" is defined in this document as the following users:
- fluffypony
- wolfcoinmooo
- hyc
...
- Users SHALL NOT log feature requests, ideas, or suggestions unrelated to WolfCoin code or WolfCoin's dependency code or WolfCoin's potential/future dependency code or research which successfully implements WolfCoin.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the WolfCoin Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the WolfCoin Maintainer Team.
